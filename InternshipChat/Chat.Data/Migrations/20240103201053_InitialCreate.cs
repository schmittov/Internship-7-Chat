    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Kada je rok za domaći?", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(3991), new TimeSpan(0, 1, 0, 0, 0)) },
                    { 2, 1, 2, "4. siječnja", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(3997), new TimeSpan(0, 1, 0, 0, 0)) },
                    { 3, 1, 2, "2024", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(4000), new TimeSpan(0, 1, 0, 0, 0)) },
                    { 4, 1, 3, "Odlično!", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(4003), new TimeSpan(0, 1, 0, 0, 0)) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, 1, "Hej, Sretan Božić!", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(3915), new TimeSpan(0, 1, 0, 0, 0)) },
                    { 2, 1, 2, "Hvala, također!", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(3968), new TimeSpan(0, 1, 0, 0, 0)) },
                    { 3, 3, 2, "Možeš li mi pomoć sutra?", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(3971), new TimeSpan(0, 1, 0, 0, 0)) },
                    { 4, 2, 3, "Moogu oko 3 popodne.", new DateTimeOffset(new DateTime(2024, 1, 3, 21, 10, 53, 509, DateTimeKind.Unspecified).AddTicks(3975), new TimeSpan(0, 1, 0, 0, 0)) }
                });
